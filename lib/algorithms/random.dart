...
import 'package:os_seekho/ui%20pages/optibealdys.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:os_seekho/util/screen_size.dart';
  ...
  Widget createTable() {
    ...
    for (int i = 0; i < frame_capacity; i++) {
      if (click == 0)
        rows.add(TableRow(children: <Widget>[
          Text(
            toprint5.elementAt(click).elementAt(i).toString(),
          ...
          .elementAt(click - 1)
          .contains(toprint5.elementAt(click).elementAt(i)))
        rows.add(TableRow(children: <Widget>[
          Text(
            toprint5.elementAt(click).elementAt(i).toString(),
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget continueButton = FlatButton(
      ...
      onPressed: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => GraphPage3()),
        );
      },
    );
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(hit5_arr.elementAt(click).toString(),
                      style: GoogleFonts.montserrat(
                ...
                Padding(
                  ...
                  child: Text(fault5_arr.elementAt(click).toString(),
                      style: GoogleFonts.montserrat(
            ...
            Row(
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text(
                      (hit5_arr.elementAt(click) / hit5_arr.length)
                          .toStringAsFixed(2),
                      style: GoogleFonts.montserrat(
                ...
                Padding(
                  padding: EdgeInsets.fromLTRB(2, 20, 8, 8),
                  child: Text(
                      (fault5_arr.elementAt(click) / hit5_arr.length)
                          .toStringAsFixed(2),
                      style: GoogleFonts.montserrat(
