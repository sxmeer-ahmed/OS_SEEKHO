      ...
      child: SafeArea(
        child: Scaffold(
          ...
          bottomNavigationBar: JumpingTabBar(
            ...
            child: SafeArea(
              child: Padding(
                ...
                child: GNav(
                  ...
                  rippleColor: Color.fromRGBO(0, 145, 124, 1),
                  ...
                  tabBackgroundColor: Color.fromRGBO(0, 145, 124, 1),
                  tabs: [
                    GButton(
                      icon: Icons.home,
                      text: 'Home',
            ...
            tabIconColor: Color.fromRGBO(0, 145, 124, 1),
            tabSelectedColor: Color.fromRGBO(0, 145, 124, 1),
