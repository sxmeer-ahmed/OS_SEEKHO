...
import 'package:google_fonts/google_fonts.dart';
//import 'package:os_seekho/ui pages/infopage.dart';
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
                ...
                children: <Widget>[
                  ...
                  RaisedButton(
                    ...
                    shape: RoundedRectangleBorder(
                        ...
                        side:
                            BorderSide(color: Color.fromRGBO(0, 145, 124, 1))),
              ...
              Padding(
                  padding: EdgeInsets.fromLTRB(8, 32, 8, 60),
                  child: Text("Entered pages are :",
                      style: GoogleFonts.poppins(
                          textStyle: TextStyle(
                              color: Colors.black,
                              fontSize: 16,
